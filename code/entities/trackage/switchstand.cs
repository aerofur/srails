...
namespace srails
{
	...
	public partial class Tp3_switch_lever_anim : AnimEntity, IUse
	{
		...
		static float[,] GetPlots(string Model, bool Fast)
		{
			return Model switch
			{
				"models/trakpak3/trakpak3_us/switchstands/racor_112e_right.vmdl" or
				"models/trakpak3/trakpak3_us/switchstands/racor_112e_left.vmdl" => new float[,] {
						{0,0.0f},
						{25,0.0f},
						{30,0.1f},
						{35,0.4f},
				...
				"models/trakpak3/trakpak3_us/switchstands/bethlehem_51a_right.vmdl" or
				"models/trakpak3/trakpak3_us/switchstands/bethlehem_51a_left.vmdl" => new float[,] {
						{0,0.0f},
						{15,0.0f},
						{50,0.6f},
						{65,0.0f},
				...
				"models/trakpak3/trakpak3_us/switchstands/racor_22_right.vmdl" or
				"models/trakpak3/trakpak3_us/switchstands/racor_22_left.vmdl" => new float[,] {
						{0,0.0f},
						{15,0.0f},
						{50,0.5f},
						{70,0.1f},
				...
				"models/trakpak3/trakpak3_us/switchstands/racor_22e_right.vmdl" or
				"models/trakpak3/trakpak3_us/switchstands/racor_22e_left.vmdl" => new float[,] {
						{0,0.0f},
						{15,0.0f},
						{60,0.6f},
						{80,0.1f},
				...
				"models/trakpak3/trakpak3_us/switchstands/grs_model5_lh_left.vmdl" or //to do: add fast switch (is it even needed?)
				"models/trakpak3/trakpak3_us/switchstands/grs_model5_lh_right.vmdl" or
				"models/trakpak3/trakpak3_us/switchstands/grs_model5_rh_left.vmdl" or
				"models/trakpak3/trakpak3_us/switchstands/grs_model5_rh_right.vmdl" => new float[,] {
						{0,0.0f},
						{90,0.0f},
						{180,1.0f},
						{270,1.0f}
					},
				"models/trakpak3/trakpak3_us/switchstands/armstrong.vmdl" => new float[,] {
						{0,0.0f},
						{10,0.0f},
						{30,1.0f},
						{40,1.0f}
		...
		public async void AnimateSwitch(Tp3_switch SwitchEntity)
		{
			...
			{
				if (-(i > 0 ? plots[i-1,0]-plots[i,0] : plots[i,0]) > 0)
				{
					if (fard == false)
					{
